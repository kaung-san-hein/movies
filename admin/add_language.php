...
<style>
 ...
 <div id="content">
			...
			<div class="portfolio-area" style="margin:0 auto; padding:20px 20px 20px 20px; width:820px;">	
				<h2 class="accordion-header" style="height: 18px;margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Movie Language Entry Form</h2>
					...
					<?php
						if(isset($_POST['submit1'])){
							mysql_query("insert into language values('','$_POST[name]','$_POST[description]')");
					?>
					<script type="text/javascript">
						window.location="add_language.php";
					</script>
					<?php
						}
					?>
