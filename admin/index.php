    	...
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<span style="margin-right: 11px;">Username: <input type="text" name="name" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br>
					...
					<?php
						if(isset($_POST['submit1'])){
							$res=mysql_query("select * from admin where name='$_POST[name]' && password='$_POST[password]'");
